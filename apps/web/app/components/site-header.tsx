 ...
 *
 * Sprint 28 ("Authentication") adds `AuthStatus` -- the one part of
 * this otherwise server-rendered header that depends on the visitor's
 * session, isolated into its own Client Component rather than making
